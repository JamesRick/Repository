 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Christine Feng");
		  toPrint += p1.toString("lfeng41");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Cory Brooks");
		  toPrint += p2.toString("cbrooks39");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Samir Ahmed");
		  toPrint += p3.toString("sahmed70");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Joseph Cho");
                  toPrint += p4.toString("jcho314");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("James Rick");
                  toPrint += p5.toString("jrick6");
